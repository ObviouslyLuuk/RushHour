...
const GIF_IDs = {
    ...
    rush_hour_png:          "1CaqIG6IcG5sNzXLqSRW0T2DxHRrpElpd",
}
...
window.addEventListener('load', function() {
    ...
    <div id="wrapper" style="display: grid; grid-template-columns: repeat(2, 50%); column-gap: 10px; row-gap: 10px; align-items: center;">
        ...
        <a href = "index.html?rushhour">
            <div class="project_name"><h3>Rush Hour</h3></div>
            <img src="${GDRIVE_LINK+GIF_IDs.rush_hour_png}" alt="Rush Hour">
        </a>
    </div>
    `
